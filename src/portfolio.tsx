  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-line bg-background/80 backdrop-blur-md">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4" aria-label="Navegación principal">
        <a href="#inicio" className="font-display text-lg font-bold tracking-tight">AR<span className="text-crimson">.</span></a>
...
function Hero() {
  return <section id="inicio" className="relative flex min-h-screen items-center overflow-hidden">
    ...
    <div className="mx-auto w-full max-w-6xl px-6 pt-24">
      ...
      <motion.p initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.25 }} className="mt-8 max-w-xl text-lg text-muted-foreground">Soy Alex Rivera, desarrollador full-stack. Diseño y programo productos digitales rápidos, accesibles y con un diseño minimalista que convierte.</motion.p>
